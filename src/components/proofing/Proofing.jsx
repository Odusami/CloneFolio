...
const Proofing = () => {
  ...
  const images = [
    "folioImages/proofing-wedding.jpg",
    "folioImages/proofing-editorial.jpg",
  ];
  useEffect(() => {
            ...
            <div className="col-12 col-md-6 col-lg-7 ps-md-3 ps-lg-5 align-items-center">
              <div className="proofingGalleryVideoGroup">
                <video
                  ...
                  loop
                >
                  <source src="folioVideos/proofing.mp4" type="video/mp4" />
                </video>
                <img
                  src="folioImages/proofing-controls.jpg"
                  className="videoControl w-50"
                  alt="Control"
                />

                <img
                  src="folioImages/favorite-selected-mobile.jpg"
                  className="coupleImg"
                  alt="Couple"
                />
          ...
          <div className="d-flex flex-column flex-sm-row align-items-center justify-content-center gap-3 gap-md-5 mb-5">
            <div className="">
              <video className="proofingVid1" autoPlay muted playsInline loop>
                <source
                  src="folioVideos/Photo-Proofing-for-Photographers - Lightfolio(1).mp4"
                  type="video/mp4"
                />
              </video>
            </div>
            <div className="text-center text-sm-start">
              <video className="proofingVid2" autoPlay muted playsInline loop>
                <source
                  src="folioVideos/Photo-Proofing-For-Photographers-Lightfolio.mp4"
                  type="video/mp4"
                />
              </video>
            </div>
              ...
              <div className="proofingImgPosition">
                <div className="d-flex justify-content-center align-items-center">
                  <div className="poofingPosition1">
                    <img
                      src="folioImages/proofing-example-2.jpg"
                  ...
                  <div className="poofingPosition2">
                    <img
                      src="folioImages/proofing-example-4.jpg"
                  ...
                  <div className="proofingPosition3">
                    <img
                      src="folioImages/proofing-example-3.jpg"
          ...
          <div className="row  py-5 reverseDirection justify-content-center">
            ...
            <div className="col-12 col-md-6">
              <div className="px-2 d-flex justify-content-center">
                <div className="w-50">
                  <img
                    src="folioImages/communication-favorite.jpg"
                  ...
                  <div className="d-flex flex-row-reverse gap-2 mt-4">
                    <img
                      src="folioImages/mug-jessica.jpg"
                      className="weddingCardChole"
                      alt="Jessica"
                    />

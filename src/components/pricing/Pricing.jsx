...
const faq={
    ...
    content1: 
        {header:'Hows does the free account work?', title:'Creating your free account gives you access to most every feature. Your account is free for life--upgrade to any paid plan for more storage.'}
    ,
    content2: 
        {header:'Am I required to sign a contract?', title:'Absolutely not. Every plan is available on a month-to-month basis.'}
    ,
    content3:
        {header:'How do I change or cancel my subscription?', title:'You can easily upgrade, change and cancel your plan at any time. There is no lock and no obligation beyond the monthly fee.'}
    ,
    content4:
        {header:'Do you charge sales commission fees?', title:'Most paid plans have no commission. The free plan charges a 15% fee only if and when you make a sale.'}
    ,
    content5:
        {header:'I have a question--how do I contact support?', title: 'We are always happy to help. Please feel free to email us at hello@clonefolio.com.'}

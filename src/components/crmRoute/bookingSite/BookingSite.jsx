          ...
          <div className="row row-cols-1 row-cols-md-2 gap-5 gap-md-0">
            ...
            <div className="col order-first order-md-last">
              <div className="hstack beachImgGroup">
                ...
                />
                <img
                  src="folioImages/beach-shoot.jpg"
          ...
          <div className="row row-cols-1 row-cols-md-2 gap-4 gap-md-0">
            ...
            <div className="col">
              <div className="hstack calenderImgGroup">
                <img
                  src="folioImages/calendar.jpg"
                  className="img-fluid"
                  alt="Calender"
                />
                <img
                  src="folioImages/photographer-phone.jpg"
                  className="img-fluid"
                  alt="Photographer"
                />
              </div>
          ...
          <div className="row row-cols-1 row-cols-md-2 gap-4 gap-md-0">
            ...
            <div className="col order-first order-md-last">
              <div className="hstack text-center bookingPowerupGroup">
                <div>
                  <img
                    src="folioImages/booking-versatility-form.jpg"
                    className="img-fluid"
                    alt="Booking Form"
                  />
                  <p>Questionnaire</p>
                ...
                <div>
                  <img
                    src="folioImages/booking-versatility-cover.jpg"
                    className="img-fluid"
                    alt="Booking Cover"
                  />
                  <p>Contract</p>
                ...
                <div>
                  <img
                    src="folioImages/booking-versatility-invoice.jpg"
                    className="img-fluid"
                    alt="Booking Invoice"
                  />
                  <p>Invoice</p>

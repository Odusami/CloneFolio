...
const Crm = ({ handleNavigation }) => {
  ...
  const rightCarousel = [
    "folioImages/docs-boudoir-contract.jpg",
    "folioImages/docs-commercial-photo-contract.jpg",
    "folioImages/docs-commercial-photography-contract.jpg",
    "folioImages/docs-engagement-shoot-contract.jpg",
    "folioImages/docs-photography-contract.jpg",
    "folioImages/docs-portrait-contract.jpg",
    "folioImages/docs-real-estate-photography-contract.jpg",
    "folioImages/docs-wedding-photo-contract.jpg",
    "folioImages/docs-wedding-photography-contract.jpg",
  ];
  const leftCarousel = [
    "folioImages/docs-family-portrait-questionnaire.jpg",
    "folioImages/docs-minor-model-release.jpg",
    "folioImages/docs-model-release.jpg",
    "folioImages/docs-photo-invoice.jpg",
    "folioImages/docs-photography-inv.jpg",
    "folioImages/docs-photography-invoice.jpg",
    "folioImages/docs-print-photo-release.jpg",
    "folioImages/docs-print-release.jpg",
    "folioImages/docs-wedding-invoice.jpg",
    "folioImages/docs-wedding-questionnaire.jpg",
  ];
  return (
    <>
      <section className="crmOneSection">
        <div className="container">
          ...
          <div className="py-5">
            <img
              src="folioImages/dashboard-5.jpg"
              className="img-fluid"
              alt="Crm Dashboard"
            />
          </div>
          ...
          <div className="row row-cols-1 row-cols-lg-2 gap-2 gap-sm-5 gap-lg-0">
            ...
            <div className="col order-first	order-lg-last">
              <div className="photographyGroup p-5 p-sm-0">
                <img
                  src="folioImages/happy-photographer.jpg"
                  className="img-fluid rounded"
                  alt="Happy Photographer"
                />
                <img
                  src="folioImages/happy-photographer-2.jpg"
              ...
              <div className="col">
                <div className="miniMutipleImgG">
                  <div className="mini1 text-center">
                    <img
                      src="folioImages/examples-minis-families.jpg"
                      className="img-fluid"
                      alt="Minis Families"
                    />
                  ...
                  <div className="mini2 text-center">
                    <img
                      src="folioImages/examples-minis-holidays.jpg"
                      className="img-fluid"
                      alt="Minis Families"
                    />
                    <h5 className="font3 colorBlack">
                  ...
                  <div className="mini3 text-center">
                    <img
                      src="folioImages/examples-minis-boudoir.jpg"
                      className="img-fluid"
                      alt="Minis Families"
                    />
                    <h5 className="font3 colorBlack">
                  ...
                  <div className="mini4 text-center">
                    <img
                      src="folioImages/examples-minis-pets.jpg"
                      className="img-fluid"
                      alt="Minis Families"
                    />
                    <h5 className="font3 colorBlack">
                  ...
                  <div className="mini5 text-center">
                    <img
                      src="folioImages/examples-minis-fun.jpg"
                      className="img-fluid"
                      alt="Minis Families"
                    />
                    <h5 className="font3 colorBlack">
          ...
          <div className="row row-cols-1 row-cols-md-2 gap-3 gap-md-0 align-items-center">
            ...
            <div className="col order-first order-md-last">
              <div className="emailGroup">
                <img
                  src="folioImages/email-airplane.png"
                  className="img-fluid"
                  alt="Email"
                />
          ...
          <div className="row row-cols-1 row-cols-md-2 align-items-center gap-3 gap-sm-5 gap-md-0">
            <div className="col">
              <div className="crmIGroup pe-5 pb-4 p-sm-0 ">
                ...
                />
                <img
                  src="folioImages/booking-beach-session.jpg"

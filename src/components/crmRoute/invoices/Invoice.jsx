...
const Invoice = () => {
  ...
  const images = [
    "folioImages/invoice-cover-wedding.jpg",
    "folioImages/invoice-white.gif",
  ];
  useEffect(() => {
            ...
            <div className="col order-first order-sm-last">
              <div className="imgPosition">
                <div className="hstack imgGroup">
                  <img
                    src="folioImages/invoice-items.gif"
                    className="img-fluid"
                    alt="Invoice"
                  />
                  <img
                    src="folioImages/16addb3a-8549-4fdb-ab10-3dbadcb7bc13.jpg"
                    className="img-fluid"
                    alt="Bride"
                  />
                </div>
              ...
              <div className="col order-first order-md-last text-center">
                <div className="cardPaymentGroup">
                  <div className="cardImage">
                    <img
                      src="folioImages/cc-mastercard.jpg"
                      className="img-fluid"
                      alt="Mastercard"
                    />
                  </div>
            ...
            <div className="row row-cols-1 row-cols-md-2 gap-5 gap-md-0">
              <div className="col ">
                <div className="cInvoiceGroup ">
                  <div className="hstack imgGroup ">
                    <img
                      src="folioImages/contract-wedding.gif"
                      className=""
                      alt="Wedding Contract"
                    />
                    <img
                      src="folioImages/invoice-wedding.gif"
                      className=""
                      alt="Wedding invoice"
                    />
                  </div>

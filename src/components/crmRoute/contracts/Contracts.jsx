      ...
      <section className="contractOneSection">
        <div className="container">
          ...
          <div className="text-center coverGroup">
            <img
              src="folioImages/documents-cover.jpg"
              className="img-fluid"
              alt="Document Cover"
            />
            <img
              src="folioImages/documents-cover-build.png"
              className="img1"
              alt="Cover Build"
            />
            <img
              src="folioImages/documents-cover-cover.png"
              className="img2"
              alt="Cover Add"
            />
            <img
              src="folioImages/documents-cover-invoice.png"
              className="img3"
              alt="Cover Invoice"
            />
          </div>
      ...
      <div className="container ">
        <div className="row row-cols-1 row-cols-md-2 gap-3 gap-md-0 paddingS">
          <div className="col text-center">
            <img
              src="folioImages/cover-page-3.jpg"
